...
#define DATA_SIZE (16*1024)
	...
	// instruction test
	instMemory[ 4] = XOR(S_REG(0), T_REG(0),T_REG(1));
	instMemory[ 5] = XOR(S_REG(1), T_REG(2),T_REG(3));
	instMemory[ 6] = XOR(S_REG(2), T_REG(2),T_REG(1));
	instMemory[ 7] = XOR(S_REG(3), T_REG(3),T_REG(0));
